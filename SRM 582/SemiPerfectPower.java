...
// CUT begin
	public static void main(String[] args){
		System.err.println("SemiPerfectPower (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            long R = Long.parseLong(Reader.nextLine());
            Reader.nextLine();
            ...
            if (doTest(L, R, __answer))
                passed++;
	    }
	    if (caseSet.size() > 0) cases = caseSet.size();
        System.err.println(String.format("%nPassed : %d/%d cases", passed, cases));

        int T = (int)(System.currentTimeMillis() / 1000) - 1528434072;
	...
	static boolean doTest(long L, long R, long __expected) {
	...
	static class Reader {
        private static final String dataFileName = "SemiPerfectPower.sample";
